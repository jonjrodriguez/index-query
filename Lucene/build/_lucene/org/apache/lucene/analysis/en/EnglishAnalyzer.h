      ...
      namespace analysis {
        namespace en {
          ...
          public:
            ...
            EnglishAnalyzer();
            EnglishAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            EnglishAnalyzer(const ::org::apache::lucene::util::Version &);
            EnglishAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
