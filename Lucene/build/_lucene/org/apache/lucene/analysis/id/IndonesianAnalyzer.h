      ...
      namespace analysis {
        namespace id {
          ...
          public:
            ...
            IndonesianAnalyzer();
            IndonesianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            IndonesianAnalyzer(const ::org::apache::lucene::util::Version &);
            IndonesianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
