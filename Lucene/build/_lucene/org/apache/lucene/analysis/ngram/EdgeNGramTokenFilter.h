      ...
      namespace analysis {
        namespace ngram {
          ...
          public:
            ...
            EdgeNGramTokenFilter(const ::org::apache::lucene::analysis::TokenStream &, jint, jint);
            EdgeNGramTokenFilter(const ::org::apache::lucene::util::Version &, const ::org::apache::lucene::analysis::TokenStream &, jint, jint);
            EdgeNGramTokenFilter(const ::org::apache::lucene::analysis::TokenStream &, const ::org::apache::lucene::analysis::ngram::EdgeNGramTokenFilter$Side &, jint, jint);
            EdgeNGramTokenFilter(const ::org::apache::lucene::analysis::TokenStream &, const ::java::lang::String &, jint, jint);
