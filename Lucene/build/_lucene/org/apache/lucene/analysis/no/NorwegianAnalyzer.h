      ...
      namespace analysis {
        namespace no {
          ...
          public:
            ...
            NorwegianAnalyzer();
            NorwegianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            NorwegianAnalyzer(const ::org::apache::lucene::util::Version &);
            NorwegianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
