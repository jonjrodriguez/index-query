        ...
        namespace core {
          ...
          public:
            enum {
              mid_init$_64fb9de3,
              mid_init$_e67dd59e,
              mid_makeStopSet_092e6fb3,
              mid_makeStopSet_b86fc6ee,
              mid_makeStopSet_7d659c81,
              mid_makeStopSet_bbdc7fc0,
              mid_makeStopSet_ac8bc37a,
            ...
            StopFilter(const ::org::apache::lucene::analysis::TokenStream &, const ::org::apache::lucene::analysis::util::CharArraySet &);
            ...
            static ::org::apache::lucene::analysis::util::CharArraySet makeStopSet(const ::java::util::List &);
            static ::org::apache::lucene::analysis::util::CharArraySet makeStopSet(const JArray< ::java::lang::String > &);
            static ::org::apache::lucene::analysis::util::CharArraySet makeStopSet(const JArray< ::java::lang::String > &, jboolean);
            ...
            static ::org::apache::lucene::analysis::util::CharArraySet makeStopSet(const ::java::util::List &, jboolean);
