      ...
      namespace analysis {
        namespace de {
          ...
          public:
            ...
            GermanAnalyzer();
            GermanAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            ...
            GermanAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
