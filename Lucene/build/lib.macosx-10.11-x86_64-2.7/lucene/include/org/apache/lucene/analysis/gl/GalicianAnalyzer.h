      ...
      namespace analysis {
        namespace gl {
          ...
          public:
            ...
            GalicianAnalyzer();
            GalicianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            GalicianAnalyzer(const ::org::apache::lucene::util::Version &);
            GalicianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
