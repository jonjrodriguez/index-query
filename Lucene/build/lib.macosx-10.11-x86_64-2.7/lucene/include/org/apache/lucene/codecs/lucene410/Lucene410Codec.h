#ifndef org_apache_lucene_codecs_lucene410_Lucene410Codec_H
#define org_apache_lucene_codecs_lucene410_Lucene410Codec_H
    ...
    namespace lucene {
      namespace codecs {
        namespace lucene410 {
          ...
          class Lucene410Codec : public ::org::apache::lucene::codecs::Codec {
          public:
            enum {
              mid_init$_54c6a166,
            ...
            explicit Lucene410Codec(jobject obj) : ::org::apache::lucene::codecs::Codec(obj) {
              if (obj != NULL)
                env->getClass(initializeClass);
            }
            Lucene410Codec(const Lucene410Codec& obj) : ::org::apache::lucene::codecs::Codec(obj) {}
...
namespace org {
  namespace apache {
    namespace lucene {
      namespace codecs {
        namespace lucene410 {
          extern PyTypeObject PY_TYPE(Lucene410Codec);

          class t_Lucene410Codec {
          public:
            PyObject_HEAD
            Lucene410Codec object;
            static PyObject *wrap_Object(const Lucene410Codec&);
