      ...
      namespace util {
        ...
        public:
          enum {
            ...
            mid_intToPrefixCoded_1064070c,
            mid_intToPrefixCodedBytes_1064070c,
            mid_longToPrefixCoded_7d39f4e5,
            mid_longToPrefixCodedBytes_7d39f4e5,
          ...
          static void intToPrefixCodedBytes(jint, jint, const ::org::apache::lucene::util::BytesRefBuilder &);
          static void longToPrefixCoded(jlong, jint, const ::org::apache::lucene::util::BytesRefBuilder &);
          static void longToPrefixCodedBytes(jlong, jint, const ::org::apache::lucene::util::BytesRefBuilder &);
