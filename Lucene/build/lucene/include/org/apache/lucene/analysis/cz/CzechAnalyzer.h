      ...
      namespace analysis {
        namespace cz {
          ...
          public:
            ...
            CzechAnalyzer();
            CzechAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            CzechAnalyzer(const ::org::apache::lucene::util::Version &);
            CzechAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
