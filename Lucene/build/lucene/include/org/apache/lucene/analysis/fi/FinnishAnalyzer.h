      ...
      namespace analysis {
        namespace fi {
          ...
          public:
            ...
            FinnishAnalyzer();
            FinnishAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            FinnishAnalyzer(const ::org::apache::lucene::util::Version &);
            FinnishAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
