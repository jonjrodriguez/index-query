      ...
      namespace analysis {
        namespace it {
          ...
          public:
            ...
            ItalianAnalyzer();
            ItalianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            ItalianAnalyzer(const ::org::apache::lucene::util::Version &);
            ItalianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
