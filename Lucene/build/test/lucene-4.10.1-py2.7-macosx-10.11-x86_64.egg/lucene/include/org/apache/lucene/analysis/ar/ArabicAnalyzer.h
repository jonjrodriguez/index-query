      ...
      namespace analysis {
        namespace ar {
          ...
          public:
            ...
            ArabicAnalyzer();
            ArabicAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            ArabicAnalyzer(const ::org::apache::lucene::util::Version &);
            ArabicAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
