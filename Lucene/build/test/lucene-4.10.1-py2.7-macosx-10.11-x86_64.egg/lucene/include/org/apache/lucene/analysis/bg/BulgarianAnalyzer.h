      ...
      namespace analysis {
        namespace bg {
          ...
          public:
            ...
            BulgarianAnalyzer();
            BulgarianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            BulgarianAnalyzer(const ::org::apache::lucene::util::Version &);
            BulgarianAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
