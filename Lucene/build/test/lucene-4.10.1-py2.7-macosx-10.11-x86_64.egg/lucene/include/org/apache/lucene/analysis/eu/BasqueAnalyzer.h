      ...
      namespace analysis {
        namespace eu {
          ...
          public:
            ...
            BasqueAnalyzer();
            BasqueAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &);
            BasqueAnalyzer(const ::org::apache::lucene::util::Version &);
            BasqueAnalyzer(const ::org::apache::lucene::analysis::util::CharArraySet &, const ::org::apache::lucene::analysis::util::CharArraySet &);
